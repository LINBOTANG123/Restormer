...
class ImageCleanModel(BaseModel):
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger,
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            # If there are more than 3 channels, combine them using RSS.
            if result_tensor.shape[0] > 3:
                # Compute the RSS combination across the channel dimension.
                # This gives a single-channel image of shape (1, H, W).
                combined_result = torch.sqrt(torch.sum(result_tensor ** 2, dim=0, keepdim=True))
                # For visualization, replicate the single channel to create a 3-channel image.
            ...
            # Now pass the combined result to tensor2img.
