...
python basicsr/train.py \
  -opt /n/netscratch/zickler_lab/Lab/linbo/denoising_project/Restormer/Denoising/Options/GaussianGrayDenoising_RestormerSigma_smooth_csm_newattn_concat.yml \
  --launcher none
